                                                ...
                                                <div className="mt-4 flex items-center justify-between border-t border-border/50 bg-black/10 px-6 py-3 -mx-6 -mb-6 rounded-b-2xl">
                                                    ...
                                                    <div className="flex items-center justify-end gap-3 text-center shrink-0 min-w-[70px]">
                                                        <div>
                                                            ...
                                                            <p className={`text-xl font-bold leading-none ${myTeam === "A" && result === "win" ? "text-accent drop-shadow-[0_0_8px_rgba(204,255,0,0.5)] scale-110" : "text-foreground"}`}>
                                                                {match.team_a_score}
                                                            </p>
                                                        </div>
                                                        ...
                                                        <div className="flex flex-col items-end">
                                                            ...
                                                            <p className={`text-xl font-bold leading-none ${myTeam === "B" && result === "win" ? "text-accent drop-shadow-[0_0_8px_rgba(204,255,0,0.5)] scale-110" : "text-foreground"}`}>
                                                                {match.team_b_score}
                                                            </p>
                                                        </div>
                                                    </div>
